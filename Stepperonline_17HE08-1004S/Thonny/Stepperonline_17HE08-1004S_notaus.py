...
GESCHWINDIGKEIT = 0.01
BESCHLEUNIGUNG = 0.01


WARTEZEIT = 0.1

def beschleunigen_motor(schritte, richtung):
    """
...
while True:
    if interrupt.value()==0:
        for i in range (ZYKLEN):
            ...
            beschleunigen_motor(SCHRITTE_PRO_UMDREHUNGEN, 1)
            print ("Beschläunigen in Uhrzeigersinn abgeschlossen")
            drehe_motor(SCHRITTE_PRO_UMDREHUNGEN, 1) # 1 volle Umdrehung
            print("Drehen und Beschleunigen fertig")
